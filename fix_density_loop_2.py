...
def fix_density(filepath):
    ...
    target = """            val currentDensity = androidx.compose.runtime.remember { androidx.compose.ui.platform.LocalDensity.current }
    ...
    replacement = """            val systemDensity = androidx.compose.ui.platform.LocalDensity.current
